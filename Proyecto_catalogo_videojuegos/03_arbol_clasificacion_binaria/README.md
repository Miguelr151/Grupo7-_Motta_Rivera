...
En esta carpeta se encuentra el notebook final del modelo de árbol de decisión para clasificación binaria aplicado al proyecto de videojuegos.
...
## Resultado
El árbol permitió visualizar reglas de decisión y comparar el desempeño del modelo antes y después del oversampling.
